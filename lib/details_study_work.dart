...
class DetailsStudyWork extends StatefulWidget {
  const DetailsStudyWork({Key? key}) : super(key: key);

  @override
  State<DetailsStudyWork> createState() => _DetailsStudyWorkState();
}

class _DetailsStudyWorkState extends State<DetailsStudyWork> {
  ...
  void _showInfoDialog(BuildContext context) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Study - work tasks'),
